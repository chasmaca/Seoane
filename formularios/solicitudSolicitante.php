...
<script src='../js/solicitudSolicitante.js'></script>
		...
		<form class="well form-horizontal" id="contact_form">
			...
			<fieldset>
					...
					<div class="col-md-4 inputGroupContainer">
						<div class="input-group">
							<span class="input-group-addon"><i
								...
								name="fecha" id="fecha" placeholder="Fecha del Evento (dd/mm/yyyy)"
								class="form-control" type="text">
						</div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-md-4">
						<div class="check">
							<label> <input type="checkbox" name="hosting" id="antes"
								value="no" /> Antes del Evento
							</label>
						</div>
						<div class="check">
							<label> <input type="checkbox" name="hosting" id="durante"
								value="no" /> Durante el Evento
							</label>
						</div>
						<div class="check">
							<label> <input type="checkbox" name="hosting" id="despues"
				...
				<div class="form-group">
					...
					<div class="col-md-4">
						<button type="button" name="enviar" id="enviar"
							...
							Comunicar <span class="glyphicon glyphicon-send"></span>
						</button>
						<button type="button" name="aprobar" id="aprobar"
							class="btn btn-warning">
							Aprobar <span class="glyphicon glyphicon-send"></span>
						</button>
						<button type="button" name="rechazar" id="rechazar"
							class="btn btn-warning">
							Rechazar <span class="glyphicon glyphicon-send"></span>
						</button>
					</div>
				</div>
			</fieldset>
