			...
			<fieldset>
				...
				<div class="form-group">
				    ...
				    <div class="col-md-4 inputGroupContainer">
				    	<div class="input-group">
				  			<span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
				  			<input name="apellido" id="apellido" placeholder="Apellidos" class="form-control"  type="text">
				    	</div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-md-4 inputGroupContainer">
						<div class="input-group">
							...
							<input name="edificio" id="edificio" placeholder="Edificio" class="form-control" type="text">
						</div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-md-4 inputGroupContainer">
						<div class="input-group">
							<span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span>
							<input name="sala" id="sala" placeholder="Sala" class="form-control" type="text">
						</div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-md-4 inputGroupContainer">
						<div class="input-group">
							<span class="input-group-addon"><i class="glyphicon glyphicon-time"></i></span>
							<input type="text" name="hora_fin" id="hora_fin" class="form-control">
						</div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-md-4">
		            	<div class="check">
		                	<label>
		                    	<input type="checkbox" name="antes" id="antes" value="no" /> Antes del Evento
							</label>
						</div>
		                <div class="check">
							<label>
		                    	<input type="checkbox" name="durante" id="durante" value="no" /> Durante el Evento
							</label>
						</div>
						  <div class="check">
							<label>
		                    	<input type="checkbox" name="despues"  id="despues" value="no" /> Despu&eacute;s del Evento
							</label>
						</div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-md-4 inputGroupContainer">
						<div class="input-group">
							...
							<textarea class="form-control" name="comment" id="comment" placeholder="Descripci&oacute;n Detallada"></textarea>
						</div>
					</div>
				</div>
				...
				<div class="form-group">
					<label class="col-md-4 control-label"></label>
						<div class="col-md-4">
						<button type="button" name="enviar" id="enviar" class="btn btn-warning" >Enviar <span class="glyphicon glyphicon-send"></span></button>
					</div>
				</div>
			</fieldset>
		</form>
								...
								<div class="jconfirm-box-container jconfirm-animated col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 col-xs-10 col-xs-offset-1 jconfirm-no-transition" style="transform: translate(0px, 0px); transition-duration: 0.4s; transition-timing-function: cubic-bezier(0.36, 0.55, 0.19, 1);">
									<div class="jconfirm-box jconfirm-hilight-shake jconfirm-type-default jconfirm-type-animated" role="dialog" aria-labelledby="jconfirm-box33538" tabindex="-1" style="transition-duration: 0.4s; transition-timing-function: cubic-bezier(0.36, 0.55, 0.19, 1); transition-property: all, margin;">
										...
										<div class="jconfirm-title-c">
											...
											<span class="jconfirm-title">Solicitud enviada con Exito!</span>
										</div>
										<div class="jconfirm-content-pane no-scroll" style="transition-duration: 0.4s; transition-timing-function: cubic-bezier(0.36, 0.55, 0.19, 1); height: 40px; max-height: 226px;">
											<div class="jconfirm-content" id="jconfirm-box33538">
												<div>Gracias por contactar con nosotros.</div>
												<div>Le responderemos lo antes posible.</div>
											</div>
										</div>
